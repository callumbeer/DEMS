var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+base_url+'assets/admin/css/theme-default.css"><img src="'+base_url+'assets/admin/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+base_url+'assets/admin/css/theme-brown.css"><img src="'+base_url+'assets/admin/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="'+base_url+'assets/admin/css/theme-blue.css"><img src="'+base_url+'assets/admin/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="'+base_url+'assets/admin/css/theme-white.css"><img src="'+base_url+'assets/admin/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="'+base_url+'assets/admin/css/theme-black.css"><img src="'+base_url+'assets/admin/img/themes/black.jpg"/></a>'
        +'</div>'
